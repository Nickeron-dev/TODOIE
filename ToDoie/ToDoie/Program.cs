    ...
    class Program
    {
        ...
        private async Task MessageReceivedAsync(SocketMessage message)
        {
            ...
            if (message.Content == "!start")
            {
                ...
                message.Channel.SendMessageAsync("Hi, ich bin dein ToDoie-Bot und helfe dir gerne deinen Alltag organisierter zu gestalten. Dies kann ich für dich tun:");
                message.Channel.SendMessageAsync("-task erstellen \n-task entfernen");
            }
        }
